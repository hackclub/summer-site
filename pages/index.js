...
export const getStaticProps = async () => {
  ...
  let endpointURL1 = `https://api2.hackclub.com/v0.1/Summer%20of%20Making%20Streaks/Updates?select={"maxRecords":10,"fields":["Attachments"],"filterByFormula:":"FIND('png', {Attachments}) > 0"}`
