    ...
    <aside>
      <h3>
        ...
        <span style={{ fontSize: '22px' }}>
          {' '}
          with support from Adafruit & Arduino{' '}
        </span>
      </h3>
          ...
          <Grid columns={[null, 2, 3]} gap={3} mt={[3, 4]} mb={[3, 4]}>
            ...
            >
              ...
              <Text
                ...
                p={[1, 2]}
              >
                <Mention username="nikhiljose" key="nikhiljosei" />
                ’s package
              </Text>
            </Card>
            <Card
