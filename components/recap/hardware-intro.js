...
export default () => (
  ...
  >
    ...
    >
      ...
      of fun experiment: <span className="highlight">distributing hardware to teenage makers with cool
      project ideas</span>. One thing we liked about hardware grants was that
      bits—however magical—are ultimately constrained by atoms. It seemed right
      to connect over building physical things during a summer when personal
      connections relied on the internet more than ever.
    </Text>
  </Container>
)
